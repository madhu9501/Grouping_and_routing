...
def process_employee_df(employee_df, center, max_emp_pickup_arc, limit_size, thr):
    ...
    try:
        ...
        new_limit = n_employees/10
        limit_size = max(limit_size, new_limit)
...
class InitRoutePlannerAPI():
    ...
    def post(self):
        ...
        try:
            ...
            emp_pick_up_range = return_data['MaxEmplPickupRadius']        
            ...
            # if not isinstance(is_manual_distance, bool):
            ...
            in_city_emp_final_cleaned_df = process_employee_df(in_city_emp_df, center, emp_pick_up_range, limit_size, thr, is_manual_distance)
            out_city_emp_final_cleaned_df = process_employee_df(out_city_emp_df, center, emp_pick_up_range, limit_size, thr, is_manual_distance)
